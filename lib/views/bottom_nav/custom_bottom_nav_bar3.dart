...
class CustomBottomNavBar3 extends StatefulWidget {
  ...
  @override
  _CustomBottomNavBar3State createState() => _CustomBottomNavBar3State();
}

class _CustomBottomNavBar3State extends State<CustomBottomNavBar3> {
